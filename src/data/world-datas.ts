...
export const MinimalWorldDatas: IWorldDataMinimal[] = [
    ...
    { source: "Adventure Time", name: "Land of Ooo" },
    { source: "Alf", earthYear: 1987, name: "San Fernando Valley" },
    { source: "Angry Birds" },
    { source: "Aquaman", earthYear: 2018 },
    { source: "Assassin's Creed II", earthYear: 1488, name: "Florence" },
    { source: "Atlantis", earthYear: 1914 },
    { source: "Avatar: The Way of Water" },
    { source: "The Bad Guys", earthYear: 2022, name: "Los Angeles 2022" },
    { source: "Banjo Kazooie" },
    { source: "Baywatch", earthYear: 1989, name: "Los Angeles 1989" },
    { source: "Bee Movie", earthYear: 2007 },
    { source: "Bionicle" },
    { source: "Bioshock", earthYear: 1960, name: "Rapture" },
    { source: "Cats & Dogs", earthYear: 2001, name: "Vancouver" },
    { source: "Cheetah Girls", earthYear: 2003 },
    { source: "Chicken Run", earthYear: 2000, name: "Tweedy Farms" },
    { source: "Coraline", earthYear: 2009 },
    { source: "Dinosaur Sitcom" },
    { source: "Doom" },
    { source: "Dragon Quest XI" },
    { source: "Earthbound", earthYear: 1994, name: "Eagleland"  },
    { source: "Road to El Dorado", earthYear: 1519, name: "El Dorado" },
    { source: "E.T. The Extra Terrestrial", earthYear: 1982, name: "California" },
    { source: "Fairy Tail" },
    { source: "Fallout 3", earthYear: 2277, name: "Washington, D.C." },
    { source: "Fallout: New Vegas", earthYear: 2281, name: "New Vegas" },
    { source: "Fifth Element", earthYear: 2297 },
    { source: "Final Fantasy VI", name: "World of Ruin" },
    { source: "Final Fantasy VII", name: "Midgar" },
    { source: "Final Fantasy VIII", name: "Balamb" },
    { source: "Final Fantasy X", name: "Spira" },
    { source: "Final Fantasy XII", name: "Ivalice" },
    { source: "Finding Nemo", earthYear: 2003, name: "Sydney, Australia" },
    { source: "Frankenstein (1931)", earthYear: 1931 },
    { source: "Frozen", earthYear: 1844, name: "Arendelle" },
    { source: "Gargoyles" },
    { source: "George of the Jungle", earthYear: 1997 },
    { source: "Godzilla '98", earthYear: 1998 },
    { source: "Grim Adventures of Billy and Mandy" },
    { source: "Half Life", earthYear: 2008, name: "Black Mesa Research Facility" },
    { source: "High School Musical", earthYear: 2006, name: "East High" },
    { source: "Hocus Pocus", earthYear: 1993, name: "Salem" },
    { source: "Hotel Transylvania", earthYear: 2012 },
    { source: "Hunger Games" },
    { source: "Ice Age" },
    { source: "Incredible Hulk (television)", earthYear: 1980, name: "California" },
    { source: "The Incredibles", earthYear: 1965 },
    { source: "Indiana Jones and the Temple of Doom", earthYear: 1935, name: "Temple of Doom" },
    { source: "Iron Man", earthYear: 2008 },
    { source: "Jackass", earthYear: 2010 },
    { source: "Jaws", earthYear: 1975 },
    { source: "Jimmy Neutron", isHub: true, name: "Retroville" },
    { source: "Jumanji", earthYear: 1995 },
    { source: "Kid Dracula" },
    { source: "Land Before Time" },
    { source: "Law & Order", earthYear: 2022, name: "NYC 2022" },
    { source: "Legend of Zelda: Wind Waker", name: "The Great Sea" },
    { source: "LEGO Indiana Jones" },
    { source: "Leprechaun", earthYear: 1993 },
    { source: "LittleBigPlanet", isHub: true },
    { source: "Little Mermaid", earthYear: 1837, name: "Atlantica" },
    { source: "Madagascar 2: Escape 2 Africa", earthYear: 2008, name: "Kenya" },
    { source: "Magnum, P.I.", earthYear: 1982, name: "Hawaii" },
    { source: "Mary Poppins", earthYear: 1964, name: "London" },
    { source: "Maximum Overdrive", isHub: true, earthYear: 1986 },
    { source: "Megamind", earthYear: 2010 },
    { source: "Men in Black", earthYear: 1997 },
    { source: "Metal Gear Solid", earthYear: 2005, name: "Shadow Moses Island" },
    { source: "Moana", earthYear: 16, name: "Polynesia" }, // Originally described as a "mythic adventure set around 2000 years ago and across a series of islands in the South Pacific."
    { source: "The Secret of Monkey Island", isHub: true, name: "Monkey Island" },
    { source: "Monster High", earthYear: 2018 },
    { source: "Monster House", earthYear: 2006 },
    { source: "Monster Squad", earthYear: 1987 },
    { source: "Monty Python and the Holy Grail" },
    { source: "The Mummy", earthYear: 1926, name: "Cairo" },
    { source: "My Life as a Teenage Robot" },
    { source: "Nanny McPhee", earthYear: 1854, name: "England" },
    { source: "Night of the Zoopocalypse" },
    { source: "Ninjago", earthYear: 2017, isHub: true },
    { source: "The Office", earthYear: 2009, name: "Scranton, PA" },
    { source: "Peter Pan", name: "Neverland" },
    { source: "Planet of the Apes" },
    { source: "Ponyo" },
    { source: "Popeye", earthYear: 1929, name: "Sweethaven" },
    { source: "Portal", earthYear: 2011, name: "Aperture Science" },
    { source: "Powerpuff Girls", earthYear: 1998, name: "Townsville" },
    { source: "Rampage", earthYear: 2018 },
    { source: "Rio", earthYear: 2011 },
    { source: "RoboCop", earthYear: 2044, name: "Old Detroit" }, // https://scifi.stackexchange.com/questions/43112/when-in-which-year-is-robocop-set#43113
    { source: "Robots" },
    { source: "Rugrats", earthYear: 1993 },
    { source: "Sabrina the Teenage Witch", earthYear: 1996 },
    { source: "Sam & Max", earthYear: 2008, isHub: true, name: "Sam & Max's NYC" },
    { source: "The Santa Clause", earthYear: 1994, name: "The North Pole" },
    { source: "Secret Life of Pets", earthYear: 2016, name: "NYC 2016" },
    { source: "The Shining", earthYear: 1980, name: "Overlook Hotel" },
    { source: "The Simpsons", earthYear: 2019, name: "Springfield" },
    { source: "Son of the Mask", earthYear: 2005, name: "Edge City" },
    { source: "Soul Eater", earthYear: 2008, name: "Death City" },
    { source: "Spyro the Dragon" },
    { source: "Spy Kids", earthYear: 2001 },
    { source: "Street Sharks" },
    { source: "Super Mario", name: "Mushroom Kingdom" },
    { source: "Super Metroid" },
    { source: "Surf Ninjas", earthYear: 1993 },
    { source: "Tarzan", earthYear: 1870, name: "Deep Jungle" },
    { source: "Three Amigos", earthYear: 1916, name: "Santa Poco" },
    { source: "Thumbelina" },
    { source: "Top Gun", earthYear: 1986 },
    { source: "Transformers One" },
    { source: "Treasure Planet" },
    { source: "Usagi Yojimbo", earthYear: 1619 },
    { source: "Veggie Tales", isHub: true },
    { source: "Veronica Mars", earthYear: 2005 },
    { source: "Walking Dead", isHub: true, earthYear: 2010 },
    { source: "WALL*E", earthYear: 2805 },
    { source: "Wallace and Gromit", earthYear: 2005 },
    { source: "Wild Wild West", earthYear: 1869 },
    { source: "Willow" },
    { source: "Wolfenstein 3D", earthYear: 1944, name: "Castle Wolfenstein" },
    { source: "XCOM: Enemy Within", earthYear: 2015 },
    { source: "Yu-Gi-Oh! Duel Monsters", earthYear: 2000 }
];